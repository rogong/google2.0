...
export default function Home() {
  ...
  return (
    <div className='flex flex-col justify-center h-screen'>
      ...
      {/* Header */}
      <header className="flex space-x-4 w-full p-5 justify-between text-sm text-gray-700">
        ...
        {/* Avatar */}
        <Avatar url="https://avatars.githubusercontent.com/u/38337273?s=400&u=e6723cb2af09b4381329c9831e91fe8a5bf89b9a&v=4" />
        </div>
      </header>
